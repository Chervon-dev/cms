...
$router->get('/admin/', DashboardController::class . '@dashboardPage');
$router->get('/admin/users', AdminUserController::class . '@usersPage');
$router->get('/admin/posts', AdminPostController::class . '@postsPage');
$router->get('/admin/pages', PageController::class . '@pagesPage');
$router->get('/admin/settings', SettingsController::class . '@settingsPage');
