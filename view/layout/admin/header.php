...
<head>
    ...
    <link href="/view/admin/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="/view/admin/assets/images/users/1.jpg" alt="user" class="profile-pic me-2">Markarn Doe
                        </a>
        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/settings" aria-expanded="false">
        ...
        <div class="sidebar-footer">
            <div class="row">
                <div class="col-4 link-wrap">
                    <a href="/admin/settings" class="link" data-toggle="tooltip" title="" data-original-title="Settings">
